...
![CRM dashboard overview](assets/screenshots/01-crm-dashboard-overview.png)

### Data management views

![Data management views](assets/screenshots/02-data-management-views.png)

### Foundry application builder and company detail drawer

![Foundry application builder and company detail drawer](assets/screenshots/03-foundry-app-builder-company-drawer.png)

### Contact workflow

![Edit contact workflow](assets/screenshots/04-edit-contact-workflow.png)

### Lead analytics dashboard

![Lead analytics dashboard](assets/screenshots/05-lead-analytics-dashboard.png)
